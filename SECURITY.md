...
It is retained only as git history (`v1-legacy` tag).

## Reporting a vulnerability

Please use **GitHub private vulnerability reporting**:
<https://github.com/Blue-B/Alienbin/security/advisories/new>
...
- No email address is published for this project; the GitHub channel above is the only
  reporting route.
